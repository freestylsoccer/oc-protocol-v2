...
import { IPofiConfiguration, eEthereumNetwork } from '../../helpers/types';
...
export const PofiConfig: IPofiConfiguration = {
  ...CommonsConfig,
  MarketId: 'Pofi genesis market',
  ProviderId: 1,
  ReservesConfig: {
    BUSD: strategyBUSD,
    DAI: strategyDAI,
